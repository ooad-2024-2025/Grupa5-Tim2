...
using OffroadAdventure.Models; // ✅ koristi tvoju klasu User
...
namespace OffroadAdventure.Areas.Identity.Pages.Account
{
    ...
    {
        // ✅ promijenjeno na SignInManager<User>
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Uspješna prijava.");
                ...
                {
                    ModelState.AddModelError(string.Empty, "Neuspjela prijava.");
                    return Page();
                }
            }
